...
grouped_by_month as(
    select distinct
       ...
       , product_name 
       , sum(product_quantity_sold) as monthly_quantity_sold          -- Cantidad vendida de producto cada mes
       , sum(product_quantity_sold * price_usd) as monthly_incomes    -- Suma del precio de venta de cada producto por la cantidad vendida
